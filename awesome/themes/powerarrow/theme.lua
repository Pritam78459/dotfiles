   ...
   s.quake = lain.util.quake({ app = "urxvt", height = 0.50, argname = "--name %s" })
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            arrow("#252525", "#0c0c0c"),
            wibox.container.background(wibox.container.margin(wibox.widget { volicon, theme.volume.widget, layout = wibox.layout.align.horizontal }, dpi(2), dpi(3)), "#0c0c0c"),
            arrow("#0c0c0c", "#252525"),
            wibox.container.background(wibox.container.margin(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, dpi(2), dpi(3)), "#252525"),
            arrow("#252525", "#4e4e4e"),
            wibox.container.background(wibox.container.margin(wibox.widget { cpuicon, cpu.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(4)), "#4e4e4e"),
            --arrow("#4B696D", "#4B3B51"),
            ...
            arrow("#4e4e4e", "#797979"),
            wibox.container.background(wibox.container.margin(wibox.widget { baticon, bat.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), "#797979"),
            arrow("#797979", "#949494"),
            wibox.container.background(wibox.container.margin(wibox.widget { nil, neticon, net.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), "#949494"),
            arrow("#949494", "#cdcdcd"),
            wibox.container.background(wibox.container.margin(clock, dpi(4), dpi(8)), "#cdcdcd"),
            arrow("#cdcdcd", "alpha"),
            --]]
            s.mylayoutbox,
        },
